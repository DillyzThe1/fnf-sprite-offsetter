// IT'S JUST A CENSORED VERSION OF https://github.com/ninjamuffin99/Funkin/blob/master/source/Alphabet.hx
...
class AlphaCharacter extends FlxSprite
{
	...
	{
		super(x, y);
		var tex = Paths.getSparrowAtlas('alphabet','title');
		frames = tex;
